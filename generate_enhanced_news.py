...
def generate_enhanced_news():
    ...
    # 1. 生成result/index.html（增强版样式）
    generate_enhanced_html(todays_insights, today_date, current_time)
    ...
    print(f"   生成文件:")
    print(f"     - result/index.html (增强版样式)")
...
def generate_enhanced_html(insights, today_date, current_time):
    """生成增强版result/index.html"""
...
'''
    ...
    print("✅ result/index.html生成完成（增强版样式）")
