...
def fix_rss_url_robust():
    """健壮修复RSS URL问题"""
    
    print("开始健壮修复RSS URL问题...")
    ...
    try:
        # 检测文件编码
        encoding = detect_encoding(resultai_file)
        print(f"检测到文件编码: {encoding}")
        
        # 尝试不同的编码方式读取文件
        encodings_to_try = ['utf-8-sig', 'gbk', 'gb2312', 'utf-8', encoding] if encoding else ['utf-8-sig', 'gbk', 'gb2312', 'utf-8']
